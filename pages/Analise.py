...
#inde = st.number_input("INDE 0 - 10", max_value=10, min_value=1, step=1.,format="%.2f" )
iaa = st.number_input("IAA 0 - 10", max_value=10, min_value=1, step=1.,format="%.2f" )
ieg = st.number_input("IEG 0 - 10", max_value=10, min_value=1, step=1.,format="%.2f" )
ips = st.number_input("IPS 0 - 10", max_value=10, min_value=1, step=1.,format="%.2f" )
ida = st.number_input("IDA 0 - 10", max_value=10, min_value=1, step=1.,format="%.2f" )
ipv = st.number_input("IPV 0 - 10", max_value=10, min_value=1, step=1.,format="%.2f" )
ian = st.number_input("IAN 0 - 10", max_value=10, min_value=1, step=1.,format="%.2f" )
ipp = st.number_input("IPP 0 - 10", max_value=10, min_value=1, step=1.,format="%.2f" )
