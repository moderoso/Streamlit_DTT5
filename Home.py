...
with tabs_2[1]: 
    ...
    with colunas_3 [0]:
        ...
        st.image("images/ev_idade.png",caption="Evasão por Idade", width=400)
        ...
        st.image("images/ev_genero.png",caption="Evasão por Gênero", width=400)		
        ...
        st.image("images/ev_ensino.png",caption="Evasão por Instituição de ensino", width=400)
        ...
        st.image("images/ev_tempo.png",caption="Evasão por Permanência no PM", width=400)	
        ...
        st.image("images/ev_fase.png",caption="Evasão por Fase", width=400)	
...
with tabs_2[2]: 
    ...
    with colunas_3 [0]:
        st.image("images/indicador_avaliacao.png",caption="Indicadores de Avaliação, descrição e seus pesos - Fonte:PEDE Pontos importantes", width=400)
 #   with colunas_3 [1]:
        st.image("images/indicador_conselho.png",caption="Indicadores de Conselho, descrição e seus pesos - Fonte:PEDE Pontos importantes", width=400)
 #	with colunas_3 [2]:
